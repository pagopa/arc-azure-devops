variable "tlscert_dev_dev_cittadini_pagopa_it" {
  default = {
    pipeline = {
...
module "tlscert_dev_dev_cittadini_pagopa_it_cert_az" {
  ...
  dns_zone_resource_group              = var.tlscert_dev_dev_cittadini_pagopa_it.pipeline.dns_zone_resource_group
  tenant_id                            = local.tlscert_dev_dev_cittadini_pagopa_it.tenant_id
  subscription_name                    = local.tlscert_dev_dev_cittadini_pagopa_it.subscription_name
  ...
  variables = merge(
    ...
    local.tlscert_dev_dev_cittadini_pagopa_it_variables
  )

  variables_secret = merge(
    var.tlscert_dev_dev_cittadini_pagopa_it.pipeline.variables_secret,
    local.tlscert_dev_dev_cittadini_pagopa_it_variables_secret
  )
