...
module "tlscert_dev_management_dev_cittadini_p4pa_pagopa_it_cert_az" {
  ...
  dns_record_name                      = var.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.pipeline.dns_record_name
  dns_zone_name                        = var.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.pipeline.dns_zone_name
  dns_zone_resource_group              = var.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.pipeline.dns_zone_resource_group
  tenant_id                            = local.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.tenant_id
  subscription_name                    = local.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.subscription_name
  subscription_id                      = local.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.subscription_id
  ...
  variables = merge(
    var.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.pipeline.variables,
    local.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it_variables
  )

  variables_secret = merge(
    var.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it.pipeline.variables_secret,
    local.tlscert_dev_management_dev_cittadini_p4pa_pagopa_it_variables_secret
  )
