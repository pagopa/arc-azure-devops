...
| <a name="module_arc_cittadini_aks_deploy"></a> [arc\_cittadini\_aks\_deploy](#module\_arc\_cittadini\_aks\_deploy) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_generic | n/a |
...
| <a name="module_arc_prod_secrets"></a> [arc\_prod\_secrets](#module\_arc\_prod\_secrets) | ./.terraform/modules/__v3__/key_vault_secrets_query | n/a |
...
| <a name="module_tlscert_citizen_internal_prod_cittadini_pagopa_it_cert_az"></a> [tlscert\_citizen\_internal\_prod\_cittadini\_pagopa\_it\_cert\_az](#module\_tlscert\_citizen\_internal\_prod\_cittadini\_pagopa\_it\_cert\_az) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_tls_cert_federated | n/a |
...
| <a name="module_tlscert_prod_prod_cittadini_pagopa_it_cert_az"></a> [tlscert\_prod\_prod\_cittadini\_pagopa\_it\_cert\_az](#module\_tlscert\_prod\_prod\_cittadini\_pagopa\_it\_cert\_az) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_tls_cert_federated | n/a |
...
| <a name="input_arc_cittadini_aks_deploy"></a> [arc\_cittadini\_aks\_deploy](#input\_arc\_cittadini\_aks\_deploy) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "name": "arc-cittadini-deploy-aks",<br/>    "path": "cittadini\\arc-cittadini-deploy-aks"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "arc-cittadini-deploy-aks",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops"<br/>  }<br/>}</pre> | no |
| <a name="input_cittadini_be"></a> [cittadini\_be](#input\_cittadini\_be) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": false,<br/>    "enable_deploy": false,<br/>    "path": "cittadini\\be"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "arc-be",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
...
| <a name="input_tlscert_citizen_internal_prod_cittadini_pagopa_it"></a> [tlscert\_citizen\_internal\_prod\_cittadini\_pagopa\_it](#input\_tlscert\_citizen\_internal\_prod\_cittadini\_pagopa\_it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "citizen.internal",<br/>    "dns_zone_name": "cittadini.pagopa.it",<br/>    "dns_zone_resource_group": "arc-p-itn-core-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\PROD",<br/>    "variables": {},<br/>    "variables_secret": {}<br/>  }<br/>}</pre> | no |
...
| <a name="input_tlscert_prod_prod_cittadini_pagopa_it"></a> [tlscert\_prod\_prod\_cittadini\_pagopa\_it](#input\_tlscert\_prod\_prod\_cittadini\_pagopa\_it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "",<br/>    "dns_zone_name": "cittadini.pagopa.it",<br/>    "dns_zone_resource_group": "arc-p-itn-core-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\PROD",<br/>    "variables": {},<br/>    "variables_secret": {}<br/>  }<br/>}</pre> | no |
